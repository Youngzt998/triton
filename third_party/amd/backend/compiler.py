...
class HIPBackend(BaseBackend):
    ...
    def make_llvmir(src, metadata, options):
        ...
        # note: unknown reason for now, but this pass and add_di_scope has to be run separately,
        #  otherwise if we put them into previous pipline, it trigger a segmentfault without any error message; could be due to a bug in mlir or pybind11
